...
{
	0x00,
    0x08,   // FSCTRL1   Frequency synthesizer control.				  //f(IF)=317KHz
    0x00,   // FSCTRL0   Frequency synthesizer control.				  //......时的频率偏移
    0x10,   // FREQ2     Frequency control word, high byte.		 //416MHz
    ...
    0x00,   // CHANNR    Channel number.													//信道数
